...
export const getSitemapXml = async (_req: Request, res: Response): Promise<void> => {
  try {
    ...
    const staticRoutes = [
      ...
      { loc: `${baseUrl}/how-to-pay`, priority: '0.65', changefreq: 'monthly' },
    ...
    // Even on error, return a valid minimal XML sitemap instead of plain text/HTML error
    const fallbackXml = `<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://mshometrends.com/</loc>
    <changefreq>daily</changefreq>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://mshometrends.com/products</loc>
    <changefreq>daily</changefreq>
