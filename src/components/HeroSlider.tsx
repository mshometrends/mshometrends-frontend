...
export const HeroSlider: React.FC = () => {
  ...
  // High-Resolution Tableware & Kitchen Hero Slides
  const heroSlides = [
    {
      id: 1,
      badge: 'Online Store for Crockery & Home Essentials',
      titleLine1: 'Crockery, Kitchen',
      italicTitle: '& Home',
      titleLine2: 'Essentials',
      description: 'Discover quality dinner sets, kitchen tools, insulated drinkware, water bottles, and home essentials at MS Home Trends with convenient online ordering and reliable delivery.',
      statNumber: '100%',
      statLabel: 'Carefully Inspected & Safe Delivery',
      statBadge: 'Quality. Value. Reliable Service.',
    ...
    {
      id: 2,
      badge: 'Dinner Sets & Porcelain Editions',
      titleLine1: 'Handcrafted',
      italicTitle: 'Luxury Tableware',
      titleLine2: 'for an elevated home',
      description: 'Handcrafted fine bone china and dinnerware sets designed for memorable dining experiences and durable daily use.',
      statNumber: '100%',
      statLabel: 'Break-Safe Delivery Guarantee',
      statBadge: 'Carefully Packaged. Dependable.',
    ...
    {
      id: 3,
      badge: 'Kitchen Tools & Cutlery Essentials',
      titleLine1: 'Everyday',
      italicTitle: 'Kitchen & Dining',
      titleLine2: 'for modern homes',
      description: 'Elevate your daily dining ritual with durable cookware tools, drinkware bottles, and stainless steel cutlery designed for long-lasting performance.',
      statNumber: 'Top Rated',
      statLabel: 'Verified Customer Satisfaction',
      statBadge: 'Quality Tested. Fast Transit.',
