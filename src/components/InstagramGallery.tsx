    ...
    <section className="py-12 sm:py-20 bg-[#FAF9F6] border-b border-stone-200 w-full">
      <div className="max-w-[1760px] 2xl:max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-14">
        ...
        <div
          ...
          className="flex items-stretch gap-3.5 sm:gap-4 overflow-x-auto pb-3 sm:pb-4 scroll-smooth scrollbar-none snap-x -mx-4 px-4 sm:mx-0 sm:px-0"
        >
          {galleryItems.map((item, idx) => (
            <motion.div
              ...
              className="group relative shrink-0 w-[210px] sm:w-[250px] lg:w-[280px] h-72 sm:h-80 rounded-3xl overflow-hidden cursor-pointer shadow-xs hover:shadow-xl transition-all duration-500 snap-start border border-stone-200 bg-stone-100"
            >
              <img
                src={item.image}
                alt={item.title}
