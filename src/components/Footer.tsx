        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 pt-6 border-t border-stone-200 text-xs">
          ...
          <div className="space-y-3.5">
            ...
            <ul className="space-y-2 text-stone-600 font-light">
              <li>
                <a
                  href="/category/dinner-sets"
                  onClick={(e) => {
                    e.preventDefault();
                    navigateToPage('category', 'dinner-sets');
                  }}
                  className="hover:text-[#0A3825] hover:underline transition-all text-left block"
                >
              ...
              <li>
                <a
                  href="/category/tea-sets"
                  onClick={(e) => {
                    e.preventDefault();
                    navigateToPage('category', 'tea-sets');
                  }}
                  className="hover:text-[#0A3825] hover:underline transition-all text-left block"
                >
              ...
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    navigateToPage('category', 'cutlery');
                  }}
                  className="hover:text-[#0A3825] hover:underline transition-all text-left block"
                >
              ...
              <li>
                <a
                  href="/category/glassware"
                  onClick={(e) => {
                    e.preventDefault();
                    navigateToPage('category', 'glassware');
                  }}
                  className="hover:text-[#0A3825] hover:underline transition-all text-left block"
                >
              ...
              <li>
                <a
                  ...
                  className="hover:text-[#0A3825] hover:underline transition-all text-left font-medium text-[#0A3825] block"
                >
