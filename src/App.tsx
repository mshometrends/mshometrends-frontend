...
function AppContent() {
  ...
  // Hide store header & footer if navigating within admin portal (/msowner/admin/login)
  const isAdminPage = path.includes('/msowner/admin') || path.includes('/ms/admin') || path.includes('/admin');
      ...
      <div className="flex-1">
        <AnimatePresence mode="wait">
          <Routes location={location}>
            ...
            {/* Secret Owner & Administrator Portal Route: /msowner/admin/login */}
            <Route path="/msowner/admin/login" element={<PageWrapper page="admin"><AdminDashboard /></PageWrapper>} />
            <Route path="/msowner/admin" element={<Navigate to="/msowner/admin/login" replace />} />
            <Route path="/msowner/admin/panel" element={<Navigate to="/msowner/admin/login" replace />} />
            <Route path="/msowner/admin/dashboard" element={<Navigate to="/msowner/admin/login" replace />} />
            <Route path="/MS/admin/panel" element={<Navigate to="/msowner/admin/login" replace />} />
            <Route path="/ms/admin/panel" element={<Navigate to="/msowner/admin/login" replace />} />
            <Route path="/admin/panel" element={<Navigate to="/msowner/admin/login" replace />} />
            <Route path="/ms/admin" element={<Navigate to="/msowner/admin/login" replace />} />
            <Route path="/admin" element={<Navigate to="/msowner/admin/login" replace />} />
            <Route path="/admin/login" element={<Navigate to="/msowner/admin/login" replace />} />
