...
export const HowToPayPage: React.FC = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      detail: 'Receiver Number: 0314 3015526. Ensure the receiver title displays as "MS Home Trends".',
      icon: Send,
    ...
    },
    {
      ...
      detail: 'Send the screenshot along with your Order ID to our WhatsApp support (+92 314 3015526) for rapid approval.',
      icon: MessageSquare,
  ...
  const paymentFAQs = [
    {
      ...
      a: 'Our dedicated payment verification desk operates 7 days a week. Once you send the transaction receipt to our WhatsApp (+92 314 3015526), your order status is verified within 10 to 30 minutes during business hours.',
    },
    {
    ...
    },
    {
      ...
      a: 'Do not worry. Simply contact our support team on WhatsApp (+92 314 3015526) with your transaction ID and Order ID. Any excess will be immediately refunded or adjusted to your order.',
    },
    {
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen text-[#0A3825] pb-20">
      <SEOHead
        title="How to Pay via EasyPaisa & Cash on Delivery | MS Home Trends"
        description="Learn how to pay for your crockery and home essentials orders using EasyPaisa (0314 3015526) or Cash on Delivery at MS Home Trends."
        ...
        >
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 bg-[#0A3825] text-white p-4 rounded-2xl border border-emerald-700/40 min-w-[320px]">
              ...
              <button
                onClick={() => handleCopy('03143015526', 'account')}
