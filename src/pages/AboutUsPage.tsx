...
export const AboutUsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-slate-800 py-16">
      <SEOHead
        title="About MS Home Trends - Quality Crockery, Kitchen & Home Essentials"
        description="Learn about MS Home Trends: an online store offering quality crockery, kitchen tools, drinkware, and everyday household essentials at reasonable prices with reliable nationwide delivery across Pakistan."
        keywords="about MS Home Trends, crockery store Pakistan, kitchen essentials online, quality dinnerware, affordable home products, MS Home Trends story"
        canonicalUrl="/about"
        jsonLd={[
      ...
      <div className="max-w-[1760px] 2xl:max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-14 space-y-20">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-slate-600 font-light leading-relaxed">
            <strong className="text-[#0A3825] font-semibold">MS Home Trends</strong> is a trusted online destination for quality crockery, kitchen tools, drinkware, home décor, and everyday household essentials. We bring aesthetic appeal and practical durability together at accessible prices, delivered safely right to your doorstep anywhere in Pakistan.
          </p>
        </div>
