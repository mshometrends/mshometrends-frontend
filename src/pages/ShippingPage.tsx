...
export const ShippingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-100 py-12 px-4 sm:px-6 lg:px-8">
      <SEOHead
        title="Shipping & Delivery Policy | MS Home Trends"
        description="Learn about MS Home Trends shock-proof packaging, same-day processing in Karachi, express delivery across Pakistan, and our 100% Zero-Breakage Guarantee."
        keywords="crockery delivery Pakistan, tableware shipping Karachi, safe packaging crockery, break-safe delivery, MS Home Trends shipping"
        ...
        <div className="bg-gradient-to-br from-emerald-950/70 to-slate-900 border border-[#D4AF37]/30 rounded-3xl p-8 sm:p-10 space-y-8 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
            ...
            <div className="p-5 bg-slate-900/80 border border-slate-700/60 rounded-2xl space-y-2.5">
              ...
              <h4 className="font-serif-title font-bold text-white text-sm">Send to Customer Support</h4>
              <p className="text-slate-300 font-light leading-relaxed">
                WhatsApp us at <strong>+92 314 3015526</strong> or email <strong>support@mshometrends.com</strong> with your Order ID and photo.
              </p>
            </div>
