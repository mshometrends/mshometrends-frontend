...
export const ContactPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] py-16 text-slate-800">
      <SEOHead
        title="Contact MS Home Trends | Customer Support & Inquiries"
        description="Get in touch with MS Home Trends. Contact our support team for order inquiries, product assistance, bulk or wedding orders, and nationwide home delivery across Pakistan."
        keywords="contact MS Home Trends, customer support, crockery store Pakistan, kitchen tools help, order inquiry, WhatsApp support"
      ...
      <div className="max-w-[1760px] 2xl:max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-14 space-y-16">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <h1 className="text-3xl sm:text-5xl font-serif-title font-bold text-[#0A3825]">
            Contact MS Home Trends
          </h1>
          <p className="text-xs sm:text-sm text-slate-500 font-light">
            Have questions regarding products, order delivery, or payment verification? We are here to help.
          </p>
        </div>
          ...
          <div className="space-y-8 bg-white border border-slate-200 p-8 rounded-3xl shadow-sm h-fit">
            ...
            <div className="space-y-6 text-xs">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-[#0A3825] block text-sm font-serif-title">Headquarters</strong>
                  <p className="text-slate-500 mt-0.5">Karachi, Sindh, Pakistan (Delivering Nationwide)</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 pt-2 border-t border-slate-200">
                ...
                <div>
                  <strong className="text-[#0A3825] block">Official Phone & WhatsApp</strong>
                  <a href="tel:+923143015526" className="text-slate-600 hover:text-[#0A3825] font-medium">
                    +92 314 3015526
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <strong className="text-[#0A3825] block">Official Support Email</strong>
                  <a href="mailto:support@mshometrends.com" className="text-slate-600 hover:text-[#0A3825]">
                    support@mshometrends.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 pt-2 border-t border-slate-200">
                ...
                <div>
                  <strong className="text-[#0A3825] block">Support Hours</strong>
                  <span className="text-slate-500">Mon - Sat: 10:00 AM - 9:00 PM (PKT)</span>
                </div>
              </div>
              ...
              <div className="pt-3">
                ...
                >
                  ...
                  <span>Chat on WhatsApp (+92 314 3015526)</span>
                </a>
              </div>
            </div>
          </div>
