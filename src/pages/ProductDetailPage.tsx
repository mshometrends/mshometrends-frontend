...
export const ProductDetailPage: React.FC = () => {
  ...
  return (
    ...
    >
      <SEOHead
        title={`${product.name} | MS Home Trends`}
        description={`${product.description?.slice(0, 155) || `Buy ${product.name} online at MS Home Trends. Quality ${product.category || 'home essentials'} with Cash on Delivery and reliable delivery across Pakistan.`}...`}
        keywords={`${product.name}, ${product.category}, buy ${product.name} online, crockery, kitchen tools, drinkware, MS Home Trends`}
