...
export const ProductsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] py-12 text-slate-800">
      <SEOHead
        title="Buy Crockery, Kitchen Tools & Home Essentials Online | MS Home Trends"
        description="Shop crockery, dinner sets, kitchen tools, drinkware, and home essentials online at MS Home Trends. Quality everyday household products with Cash on Delivery and nationwide shipping across Pakistan."
        keywords="crockery online Pakistan, kitchen tools, drinkware, dinner sets, home essentials, MS Home Trends catalog, buy crockery online"
        canonicalUrl="/products"
        jsonLd={[
          buildCollectionSchema('Crockery, Kitchen & Home Essentials', 'Browse the complete collection of quality crockery, kitchen tools, drinkware, and home essentials at MS Home Trends.', filtered),
        ...
        <div className="border-b border-slate-200 pb-6 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl font-serif-title font-bold text-[#0A3825] mt-1">
              Crockery, Kitchen & Home Essentials Catalog
            </h1>
            <p className="text-xs sm:text-sm text-slate-500 font-light mt-1">
              Showing {filtered.length} products with safe delivery across Pakistan
            </p>
          </div>
